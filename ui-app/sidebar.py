"""This module defines the sidebar for the LangChain Rag Applictaion."""
import streamlit as st
from api_utils import upload_document, list_documents, delete_document

def display_sidebar():
    """Displays the sidebar with model selection and document upload."""
    ...
    if documents:
        for doc in documents:
            st.sidebar.markdown(f"- {doc['filename']} (ID: {doc['id']})")
